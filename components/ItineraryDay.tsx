/**
 * Reusable UI component for the itinerary day section of the planner.
      ...
      {stops.length > 0 ? (
        <div className="space-y-3">
          {stops.map((stop, index) => {
            const mapsLink = sanitizeExternalNavigationUrl(stop.mapsUrl);
            const websiteLink = sanitizeExternalNavigationUrl(stop.websiteUrl);
